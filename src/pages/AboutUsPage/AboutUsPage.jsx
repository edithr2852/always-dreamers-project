  ...
  return (
    <>
      ...
      <section className="aboutUs-Daca">
        ...
        <h3>
          For those who may not know, DACA is an immigration program which was
          signed in 2012 under former president Barack Obama's administration.
          The program functions as temporary respite for the young and
          undocumented immigrants of America by delaying deportation for them,
          helping Dreamers by giving them a chance to study and work in the
          United States.
        </h3>
        <h3>
