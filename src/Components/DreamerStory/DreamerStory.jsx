    ...
    <div className="dreamersStoryPage">
      <div className="panel-body no-border">
        <dl>
          ...
          <dd>
            <a href={dreamer.personalLink} target="_blank" className="neon">
              {dreamer.personalLink}
            </a>
          </dd>
        </dl>
      </div>
      <div className="panel-footer">
        <Link to="/" className="panel-footer link">
          <button className="btn btn-3">RETURN TO LIST</button>
        </Link>
      </div>
    </div>
  );
